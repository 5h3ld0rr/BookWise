...
namespace BookWise
{
    public class Book
    {
        ...
        {
            string query = "SELECT id, name, isbn_no, author, category FROM Books";
        ...
        {
            string query = "%" + _query + "%";
            string searchQuery = "SELECT id, name, isbn_no, author, category FROM Books WHERE name LIKE @query OR isbn_no LIKE @query OR author LIKE @query OR category LIKE @query";
